...
enum {
	...
	ALC255_FIXUP_ACER_CRUX_MIC_NO_PRESENCE,
};
...
static const struct hda_fixup alc269_fixups[] = {
	...
	[ALC255_FIXUP_ACER_CRUX_MIC_NO_PRESENCE] = {
		.type = HDA_FIXUP_PINS,
		.v.pins = (const struct hda_pintbl[]) {
			{ 0x19, 0x03a11950 }, /* use as headset mic, without its own jack detect */
			{ 0x1a, 0x90a60c40 }, /* use as internal DMIC */
			{ 0x21, 0x02211430 }, /* use as headphone */
			{ }
		},
		.chained = true,
		.chain_id = ALC255_FIXUP_HEADSET_MODE_NO_HP_MIC
...
static const struct snd_pci_quirk alc269_fixup_tbl[] = {
	...
	SND_PCI_QUIRK(0x1025, 0x1330, "Acer TravelMate X514-51T", ALC255_FIXUP_ACER_CRUX_MIC_NO_PRESENCE),
