...
#define REG_AFE_CTRL2_8814B 0x0028
#define REG_AFE_CTRL3_8814B 0x002C
...
#define REG_BIST_CTRL_8814B 0x00D0
#define REG_BIST_RPT_8814B 0x00D4
#define REG_MEM_CTRL_8814B 0x00D8
#define REG_AFE_CTRL8_8814B 0x00DC
...
#define REG_SYS_CFG3_8814B 0x1000
#define REG_SYS_CFG4_8814B 0x1034
...
#define REG_SW_FLUSH_8814B 0x10C4
...
#define REG_MBIST_FAIL_8814B 0x0170
#define REG_MBIST_START_PAUSE_8814B 0x0174
#define REG_MBIST_DONE_8814B 0x0178
#define REG_MBIST_FAIL_NRML_8814B 0x017C
...
#define REG_LLT_INIT_8814B 0x01E0
#define REG_LLT_INIT_ADDR_8814B 0x01E4
...
#define REG_FIFOPAGE_CTRL_1_8814B 0x0200
#define REG_FIFOPAGE_CTRL_2_8814B 0x0204
...
#define REG_TQPNT1_8814B 0x0218
#define REG_TQPNT2_8814B 0x021C
#define REG_TQPNT3_8814B 0x0220
#define REG_TQPNT4_8814B 0x0224
#define REG_RQPN_CTRL_1_8814B 0x0228
#define REG_RQPN_CTRL_2_8814B 0x022C
#define REG_FIFOPAGE_INFO_1_8814B 0x0230
#define REG_FIFOPAGE_INFO_2_8814B 0x0234
#define REG_FIFOPAGE_INFO_3_8814B 0x0238
#define REG_FIFOPAGE_INFO_4_8814B 0x023C
#define REG_FIFOPAGE_INFO_5_8814B 0x0240
...
#define REG_RXPKT_NUM_8814B 0x0284
...
#define REG_INT_MIG_8814B 0x0304
#define REG_BCNQ_TXBD_DESA_8814B 0x0308
#define REG_MGQ_TXBD_DESA_8814B 0x0310
#define REG_VOQ_TXBD_DESA_8814B 0x0318
#define REG_VIQ_TXBD_DESA_8814B 0x0320
#define REG_BEQ_TXBD_DESA_8814B 0x0328
#define REG_BKQ_TXBD_DESA_8814B 0x0330
#define REG_RXQ_RXBD_DESA_8814B 0x0338
#define REG_HI0Q_TXBD_DESA_8814B 0x0340
#define REG_HI1Q_TXBD_DESA_8814B 0x0348
#define REG_HI2Q_TXBD_DESA_8814B 0x0350
#define REG_HI3Q_TXBD_DESA_8814B 0x0358
#define REG_HI4Q_TXBD_DESA_8814B 0x0360
#define REG_HI5Q_TXBD_DESA_8814B 0x0368
#define REG_HI6Q_TXBD_DESA_8814B 0x0370
#define REG_HI7Q_TXBD_DESA_8814B 0x0378
#define REG_MGQ_TXBD_NUM_8814B 0x0380
#define REG_RX_RXBD_NUM_8814B 0x0382
#define REG_VOQ_TXBD_NUM_8814B 0x0384
#define REG_VIQ_TXBD_NUM_8814B 0x0386
#define REG_BEQ_TXBD_NUM_8814B 0x0388
#define REG_BKQ_TXBD_NUM_8814B 0x038A
#define REG_HI0Q_TXBD_NUM_8814B 0x038C
#define REG_HI1Q_TXBD_NUM_8814B 0x038E
#define REG_HI2Q_TXBD_NUM_8814B 0x0390
#define REG_HI3Q_TXBD_NUM_8814B 0x0392
#define REG_HI4Q_TXBD_NUM_8814B 0x0394
#define REG_HI5Q_TXBD_NUM_8814B 0x0396
#define REG_HI6Q_TXBD_NUM_8814B 0x0398
#define REG_HI7Q_TXBD_NUM_8814B 0x039A
#define REG_TSFTIMER_HCI_8814B 0x039C
#define REG_BD_RWPTR_CLR_8814B 0x039C
#define REG_VOQ_TXBD_IDX_8814B 0x03A0
#define REG_VIQ_TXBD_IDX_8814B 0x03A4
#define REG_BEQ_TXBD_IDX_8814B 0x03A8
#define REG_BKQ_TXBD_IDX_8814B 0x03AC
#define REG_MGQ_TXBD_IDX_8814B 0x03B0
#define REG_RXQ_RXBD_IDX_8814B 0x03B4
#define REG_HI0Q_TXBD_IDX_8814B 0x03B8
#define REG_HI1Q_TXBD_IDX_8814B 0x03BC
#define REG_HI2Q_TXBD_IDX_8814B 0x03C0
#define REG_HI3Q_TXBD_IDX_8814B 0x03C4
#define REG_HI4Q_TXBD_IDX_8814B 0x03C8
#define REG_HI5Q_TXBD_IDX_8814B 0x03CC
#define REG_HI6Q_TXBD_IDX_8814B 0x03D0
#define REG_HI7Q_TXBD_IDX_8814B 0x03D4
#define REG_DBG_SEL_V1_8814B 0x03D8
#define REG_PCIE_HRPWM1_V1_8814B 0x03D9
#define REG_PCIE_HCPWM1_V1_8814B 0x03DA
#define REG_PCIE_CTRL2_8814B 0x03DB
#define REG_PCIE_HRPWM2_V1_8814B 0x03DC
#define REG_PCIE_HCPWM2_V1_8814B 0x03DE
...
#define REG_CMU_DLY_CTRL_8814B 0x1310
#define REG_CMU_DLY_CFG_8814B 0x1314
#define REG_H2CQ_TXBD_DESA_8814B 0x1320
#define REG_H2CQ_TXBD_NUM_8814B 0x1328
#define REG_H2CQ_TXBD_IDX_8814B 0x132C
#define REG_H2CQ_CSR_8814B 0x1330
#define REG_Q0_INFO_8814B 0x0400
#define REG_Q1_INFO_8814B 0x0404
#define REG_Q2_INFO_8814B 0x0408
#define REG_Q3_INFO_8814B 0x040C
#define REG_MGQ_INFO_8814B 0x0410
#define REG_HIQ_INFO_8814B 0x0414
#define REG_BCNQ_INFO_8814B 0x0418
#define REG_TXPKT_EMPTY_8814B 0x041A
#define REG_CPU_MGQ_INFO_8814B 0x041C
#define REG_FWHW_TXQ_CTRL_8814B 0x0420
#define REG_DATAFB_SEL_8814B 0x0423
#define REG_BCNQ_BDNY_V1_8814B 0x0424
...
#define REG_ARFR1_V1_8814B 0x044C
#define REG_CCK_CHECK_8814B 0x0454
#define REG_AMPDU_MAX_TIME_V1_8814B 0x0455
#define REG_BCNQ1_BDNY_V1_8814B 0x0456
#define REG_AMPDU_MAX_LENGTH_8814B 0x0458
#define REG_ACQ_STOP_8814B 0x045C
...
#define REG_CMDQ_INFO_8814B 0x0464
#define REG_Q4_INFO_8814B 0x0468
#define REG_Q5_INFO_8814B 0x046C
#define REG_Q6_INFO_8814B 0x0470
#define REG_Q7_INFO_8814B 0x0474
...
#define REG_MACID_SLEEP3_8814B 0x0484
#define REG_MACID_SLEEP1_8814B 0x0488
#define REG_ARFR2_V1_8814B 0x048C
#define REG_ARFR3_V1_8814B 0x0494
#define REG_ARFR4_8814B 0x049C
#define REG_ARFR5_8814B 0x04A4
...
#define REG_MACID_SLEEP2_8814B 0x04D0
#define REG_MACID_SLEEP_8814B 0x04D4
...
#define REG_NULL_PKT_STATUS_V1_8814B 0x04E0
#define REG_PTCL_ERR_STATUS_8814B 0x04E2
#define REG_NULL_PKT_STATUS_EXTEND_8814B 0x04E3
#define REG_VIDEO_ENHANCEMENT_FUN_8814B 0x04E4
#define REG_BT_POLLUTE_PKT_CNT_8814B 0x04E8
#define REG_PTCL_DBG_8814B 0x04EC
#define REG_CPUMGQ_TIMER_CTRL2_8814B 0x04F4
#define REG_DUMMY_PAGE4_V1_8814B 0x04FC
#define REG_MOREDATA_8814B 0x04FE
#define REG_Q0_Q1_INFO_8814B 0x1400
#define REG_Q2_Q3_INFO_8814B 0x1404
#define REG_Q4_Q5_INFO_8814B 0x1408
#define REG_Q6_Q7_INFO_8814B 0x140C
#define REG_MGQ_HIQ_INFO_8814B 0x1410
#define REG_CMDQ_BCNQ_INFO_8814B 0x1414
#define REG_USEREG_SETTING_8814B 0x1420
#define REG_AESIV_SETTING_8814B 0x1424
#define REG_BF0_TIME_SETTING_8814B 0x1428
#define REG_BF1_TIME_SETTING_8814B 0x142C
#define REG_BF_TIMEOUT_EN_8814B 0x1430
#define REG_MACID_RELEASE0_8814B 0x1434
#define REG_MACID_RELEASE1_8814B 0x1438
#define REG_MACID_RELEASE2_8814B 0x143C
#define REG_MACID_RELEASE3_8814B 0x1440
#define REG_MACID_RELEASE_SETTING_8814B 0x1444
#define REG_FAST_EDCA_VOVI_SETTING_8814B 0x1448
#define REG_FAST_EDCA_BEBK_SETTING_8814B 0x144C
#define REG_MACID_DROP0_8814B 0x1450
#define REG_MACID_DROP1_8814B 0x1454
#define REG_MACID_DROP2_8814B 0x1458
#define REG_MACID_DROP3_8814B 0x145C
#define REG_R_MACID_RELEASE_SUCCESS_0_8814B 0x1460
#define REG_R_MACID_RELEASE_SUCCESS_1_8814B 0x1464
#define REG_R_MACID_RELEASE_SUCCESS_2_8814B 0x1468
#define REG_R_MACID_RELEASE_SUCCESS_3_8814B 0x146C
#define REG_MGG_FIFO_CRTL_8814B 0x1470
#define REG_MGG_FIFO_INT_8814B 0x1474
#define REG_MGG_FIFO_LIFETIME_8814B 0x1478
#define REG_R_MACID_RELEASE_SUCCESS_CLEAR_OFFSET_8814B 0x147C
#define REG_MU_TX_CTL_8814B 0x14C0
#define REG_MU_STA_GID_VLD_8814B 0x14C4
#define REG_MU_STA_USER_POS_INFO_8814B 0x14C8
#define REG_MU_TRX_DBG_CNT_8814B 0x14D0
...
#define REG_TSFTR_SYN_OFFSET_8814B 0x0518
...
#define REG_MBSSID_CTRL_8814B 0x0526
#define REG_P2PPS_CTRL_8814B 0x0527
#define REG_PKT_LIFETIME_CTRL_8814B 0x0528
#define REG_P2PPS_SPEC_STATE_8814B 0x052B
#define REG_BAR_TX_CTRL_8814B 0x0530
#define REG_TBTT_PROHIBIT_8814B 0x0540
#define REG_P2PPS_STATE_8814B 0x0543
#define REG_RD_NAV_NXT_8814B 0x0544
#define REG_NAV_PROT_LEN_8814B 0x0546
#define REG_BCN_CTRL_8814B 0x0550
#define REG_BCN_CTRL_CLINT0_8814B 0x0551
#define REG_MBID_NUM_8814B 0x0552
#define REG_DUAL_TSF_RST_8814B 0x0553
#define REG_MBSSID_BCN_SPACE_8814B 0x0554
#define REG_DRVERLYINT_8814B 0x0558
#define REG_BCNDMATIM_8814B 0x0559
#define REG_ATIMWND_8814B 0x055A
#define REG_USTIME_TSF_8814B 0x055C
#define REG_BCN_MAX_ERR_8814B 0x055D
#define REG_RXTSF_OFFSET_CCK_8814B 0x055E
#define REG_RXTSF_OFFSET_OFDM_8814B 0x055F
#define REG_TSFTR_8814B 0x0560
#define REG_TSFTR_1_8814B 0x0564
#define REG_FREERUN_CNT_8814B 0x0568
#define REG_FREERUN_CNT_1_8814B 0x056C
#define REG_ATIMWND1_V1_8814B 0x0570
#define REG_TBTT_PROHIBIT_INFRA_8814B 0x0571
#define REG_CTWND_8814B 0x0572
#define REG_BCNIVLCUNT_8814B 0x0573
#define REG_BCNDROPCTRL_8814B 0x0574
#define REG_HGQ_TIMEOUT_PERIOD_8814B 0x0575
#define REG_TXCMD_TIMEOUT_PERIOD_8814B 0x0576
#define REG_MISC_CTRL_8814B 0x0577
#define REG_BCN_CTRL_CLINT1_8814B 0x0578
#define REG_BCN_CTRL_CLINT2_8814B 0x0579
#define REG_BCN_CTRL_CLINT3_8814B 0x057A
#define REG_EXTEND_CTRL_8814B 0x057B
#define REG_P2PPS1_SPEC_STATE_8814B 0x057C
#define REG_P2PPS1_STATE_8814B 0x057D
#define REG_P2PPS2_SPEC_STATE_8814B 0x057E
#define REG_P2PPS2_STATE_8814B 0x057F
#define REG_PS_TIMER0_8814B 0x0580
#define REG_PS_TIMER1_8814B 0x0584
#define REG_PS_TIMER2_8814B 0x0588
#define REG_TBTT_CTN_AREA_8814B 0x058C
#define REG_FORCE_BCN_IFS_8814B 0x058E
#define REG_TXOP_MIN_8814B 0x0590
#define REG_PRE_BKF_TIME_8814B 0x0592
#define REG_CROSS_TXOP_CTRL_8814B 0x0593
#define REG_ATIMWND2_8814B 0x05A0
#define REG_ATIMWND3_8814B 0x05A1
#define REG_ATIMWND4_8814B 0x05A2
#define REG_ATIMWND5_8814B 0x05A3
#define REG_ATIMWND6_8814B 0x05A4
#define REG_ATIMWND7_8814B 0x05A5
#define REG_ATIMUGT_8814B 0x05A6
#define REG_HIQ_NO_LMT_EN_8814B 0x05A7
#define REG_DTIM_COUNTER_ROOT_8814B 0x05A8
#define REG_DTIM_COUNTER_VAP1_8814B 0x05A9
#define REG_DTIM_COUNTER_VAP2_8814B 0x05AA
#define REG_DTIM_COUNTER_VAP3_8814B 0x05AB
#define REG_DTIM_COUNTER_VAP4_8814B 0x05AC
#define REG_DTIM_COUNTER_VAP5_8814B 0x05AD
#define REG_DTIM_COUNTER_VAP6_8814B 0x05AE
#define REG_DTIM_COUNTER_VAP7_8814B 0x05AF
#define REG_DIS_ATIM_8814B 0x05B0
#define REG_EARLY_128US_8814B 0x05B1
#define REG_P2PPS1_CTRL_8814B 0x05B2
#define REG_P2PPS2_CTRL_8814B 0x05B3
#define REG_TIMER0_SRC_SEL_8814B 0x05B4
#define REG_NOA_UNIT_SEL_8814B 0x05B5
#define REG_P2POFF_DIS_TXTIME_8814B 0x05B7
#define REG_MBSSID_BCN_SPACE2_8814B 0x05B8
#define REG_MBSSID_BCN_SPACE3_8814B 0x05BC
...
#define REG_TXCMD_NOA_SEL_8814B 0x05CF
#define REG_NOA_PARAM_8814B 0x05E0
#define REG_NOA_PARAM_1_8814B 0x05E4
#define REG_NOA_PARAM_2_8814B 0x05E8
#define REG_NOA_PARAM_3_8814B 0x05EC
#define REG_P2P_RST_8814B 0x05F0
#define REG_SCHEDULER_RST_8814B 0x05F1
#define REG_SCH_TXCMD_8814B 0x05F8
#define REG_PAGE5_DUMMY_8814B 0x05FC
#define REG_CPUMGQ_TX_TIMER_8814B 0x1500
#define REG_PS_TIMER_A_8814B 0x1504
#define REG_PS_TIMER_B_8814B 0x1508
#define REG_PS_TIMER_C_8814B 0x150C
#define REG_PS_TIMER_ABC_CPUMGQ_TIMER_CRTL_8814B 0x1510
#define REG_CPUMGQ_TX_TIMER_EARLY_8814B 0x1514
#define REG_PS_TIMER_A_EARLY_8814B 0x1515
#define REG_PS_TIMER_B_EARLY_8814B 0x1516
#define REG_PS_TIMER_C_EARLY_8814B 0x1517
#define REG_WMAC_CR_8814B 0x0600
#define REG_WMAC_FWPKT_CR_8814B 0x0601
#define REG_FW_STS_FILTER_8814B 0x0602
#define REG_BWOPMODE_8814B 0x0603
...
#define REG_MBIDCAMCFG_1_8814B 0x0628
#define REG_MBIDCAMCFG_2_8814B 0x062C
...
#define REG_RPFM_MAP1_8814B 0x0646
...
#define REG_RXFLTMAP_8814B 0x06A4
...
#define REG_TX_CSI_RPT_PARAM_BW80_8814B 0x06FC
...
#define REG_WMAC_MU_BF_OPTION_8814B 0x167C
#define REG_WMAC_PAUSE_BB_CLR_TH_8814B 0x167D
#define REG_WMAC_MU_ARB_8814B 0x167E
#define REG_WMAC_MU_OPTION_8814B 0x167F
#define REG_WMAC_MU_BF_CTL_8814B 0x1680
#define REG_WMAC_MU_BIT_BFRPT_PARA_8814B 0x1682
...
#define REG_WMAC_PLCP_MONITOR_MUTX_8814B 0x1698
...
#define REG_ANTENNA_TRAINING_CONTROL_REGISTER_8814B 0x07B0
#define REG_ANTENNA_TRAINING_CONTROL_REGISTER_1_8814B 0x07B4
#define REG_WMAC_PKTCNT_RWD_8814B 0x07B8
#define REG_WMAC_PKTCNT_CTRL_8814B 0x07BC
