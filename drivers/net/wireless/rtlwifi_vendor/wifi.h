...
#define TX_PWR_BY_RATE_NUM_RATE		84	/* compatible with TX_PWR_BY_RATE_NUM_SECTION */
...
struct rtl_phy {
	...
	u32 tx_power_by_rate_offset[TX_PWR_BY_RATE_NUM_BAND]
				   ...
				   [TX_PWR_BY_RATE_NUM_RF]
				   [TX_PWR_BY_RATE_NUM_RATE];	/* compatible with TX_PWR_BY_RATE_NUM_SECTION*/
...
struct rtl_halmac_ops {
	...
	int (*halmac_set_mac_address)(struct rtl_priv *rtlpriv, u8 hwport, u8 *addr);
	...
	int (*halmac_set_bandwidth)(struct rtl_priv *rtlpriv, u8 channel, u8 pri_ch_idx, u8 bw);
...
struct rtl_phydm_ops {
	...
	/* read/write reg */
	u32  (*phydm_read_rf_reg)(struct rtl_priv *rtlpriv, enum radio_path rfpath,
				 u32 addr, u32 mask);
	bool (*phydm_write_rf_reg)(struct rtl_priv *rtlpriv, enum radio_path rfpath,
				 u32 addr, u32 mask, u32 data);
	u8   (*phydm_read_txagc)(struct rtl_priv *rtlpriv, enum radio_path rfpath, u8 hw_rate);
	...
	u32  (*phydm_query_counter)(struct rtl_priv *rtlpriv, const char *info_type);
