...
DECLARE_PCI_FIXUP_FINAL(PCI_VENDOR_ID_REALTEK, PCI_DEVICE_ID_REALTEK_8821, quirk_disable_all_msi);
DECLARE_PCI_FIXUP_FINAL(PCI_VENDOR_ID_REALTEK, PCI_DEVICE_ID_REALTEK_8723, quirk_disable_all_msi);
...
static const struct dmi_system_id broken_msi_table[] = {
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "ASUSTeK COMPUTER INC."),
			DMI_MATCH(DMI_PRODUCT_NAME, "X456UR"),
		},
	},
	{
		/* Asus laptop with PCIe AER spam when MSI is enabled. */
