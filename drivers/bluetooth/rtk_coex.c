...
EXPORT_SYMBOL_GPL(rtk_btcoex_parse_cmd);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_parse_event);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_parse_l2cap_data_tx);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_parse_l2cap_data_rx);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_open);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_close);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_probe);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_init);
...
EXPORT_SYMBOL_GPL(rtk_btcoex_exit);

MODULE_AUTHOR("");
MODULE_DESCRIPTION("Realtek Bluetooth USB driver");
MODULE_LICENSE("GPL");
