...
/* { pid, lmp_sub, mp_fw_name, fw_name, config_name, fw_cache, fw_len } */
	...
	{0x3526, 0x8822, "mp_rtl8822bu_fw", "rtl_bt/rtl8822b_fw.bin", "rtl_bt/rtl8822b_config.bin", NULL, 0}, /* RTL8822BU for ASUS */
...
void rtk_misc_patch_remove(struct usb_interface *intf)
{
	...
	RTKBT_DBG("rtk_misc_patch_remove");
	list_del(&dev_entry->list_node);
	kfree(dev_entry);
}
EXPORT_SYMBOL_GPL(rtk_misc_patch_remove);
